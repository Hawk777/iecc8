...
namespace Iecc8.UI.Equipment {
	/// <summary>
	/// Interaction logic for Wye.xaml
	/// </summary>
	public partial class Wye : TrackSection {
		/// <summary>
		...
		/// </summary>
		public static readonly DependencyProperty PointsIDProperty = DependencyProperty.Register(nameof(PointsID), typeof(short), typeof(Wye));
		...
		protected override void Update() {
			if (PointsObject != null) {
				...
				Polygon.Data = (PathGeometry) FindResource(PointsObject.Reversed ? "WyeReverse" : "WyeNormal");
			}
		}
